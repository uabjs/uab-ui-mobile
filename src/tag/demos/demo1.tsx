...
import { Tag, Space } from 'uab-ui-mobile'
    ...
    <>
      ...
      <DemoBlock title='通过 CSS 变量个性化'>
        <Space>
          ...
          <Tag color='warning' style={{ '--text-color': 'var(--uabm-color-text)' }}>
            Warning
          </Tag>
          <Tag color='danger' fill='outline' style={{ '--border-color': 'var(--uabm-color-weak)' }}>
            Danger
          </Tag>
        </Space>
      </DemoBlock>
