...
const classPrefix = `uabm-error-block`
...
export type ErrorBlockProps = {
  ...
  '--image-height' | '--image-height-full-page' | '--image-width' | '--image-width-full-page'
>
    ...
    return withNativeProps(
      ...
      >
        ...
        <div className={`${classPrefix}-description`}>
          ...
          {des && <div className={`${classPrefix}-description-subtitle`}>{des}</div>}
        </div>
