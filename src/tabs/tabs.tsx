import React, { FC, ReactNode, useRef, ReactElement, ComponentProps } from 'react'
      ...
      <div className={`${classPrefix}-header`}>
        ...
        >
          ...
          <animated.div
            ...
            style={{
              width:
                props.activeLineMode === 'fixed' ? 'var(--fixed-active-line-width, 30px)' : width,
              x,
            }}
          />
